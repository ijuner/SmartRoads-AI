...
python -m pip install fastapi streamlit opencv-python numpy uvicorn requests python-multipart pillow ultralytics

:: Start the server in a new command window
echo Starting the FastAPI server...
start cmd /k python face_detection_server_yolo.py
